...
public class CustomButtonThin extends Button {

    Context context;
    public CustomButtonThin(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        this.context=context;
        init();
    }

    public CustomButtonThin(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public CustomButtonThin(Context context) {
        super(context);
        init();
    }
